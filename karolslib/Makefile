...
math.o:
	$(CC) $(CCFLAGS) $(SD)/utils/math.cpp -c -o $(BD)/math.o

module.o:
	$(CC) $(CCFLAGS) $(SD)/utils/module.cpp -c -o $(BD)/module.o

terminal.o:
	$(CC) $(CCFLAGS) $(SD)/window/terminal.cpp -c -o $(BD)/terminal.o

utils.o:
	$(CC) $(CCFLAGS) $(SD)/utils/utils.cpp -c -o $(BD)/utils.o
